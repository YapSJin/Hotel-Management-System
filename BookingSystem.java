...
public class BookingSystem {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            switch (choice) {
                case 1 -> Room.viewRooms(rooms);
                case 2 -> Booking.bookRoom(scanner, rooms, bookings, bookingCounter++);
                case 3 -> Booking.modifyReservation(scanner, bookings, rooms, payments);
                case 4 -> Payment.makePayment(scanner, bookings, payments, paymentCounter++);
                case 5 -> Payment.viewPayments(payments);
